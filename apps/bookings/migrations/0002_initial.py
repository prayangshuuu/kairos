    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("host", "Host"), ("invitee", "Invitee"), ("system", "System")],
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=django.contrib.postgres.constraints.ExclusionConstraint(
                condition=models.Q(("status__in", ("pending", "pending_payment", "confirmed"))),
                expressions=[("host", "="), ("buffered_period", "&&")],
