...
class PaymentAccountAdmin(admin.ModelAdmin):
    list_display = ('user', 'provider', 'external_account_id', 'charges_enabled', 'payouts_enabled', 'is_active')
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('uid', 'booking', 'provider', 'amount_cents', 'currency', 'status', 'created_at')
    list_filter = ('provider', 'status', 'currency', 'created_at')
    search_fields = ('uid', 'booking__uid', 'invoice_number', 'external_session_id', 'external_payment_intent_id')
    readonly_fields = ('uid', 'invoice_number', 'fee_amount_cents', 'gateway_fee_cents', 'net_owed_cents', 'created_at', 'updated_at')
...
class PayoutAdmin(admin.ModelAdmin):
    list_display = ('id', 'host', 'period_start', 'period_end', 'net_cents', 'status', 'initiated_at')
    list_filter = ('status',)
