...
from apps.accounts.services import process_avatar, anonymize_user
...
class SettingsTests(TestCase):
    ...
    def test_avatar_upload_strips_exif_and_resizes(self):
        ...
        upload = InMemoryUploadedFile(img_bytes, 'ImageField', 'test.jpg', 'image/jpeg', len(img_bytes.getvalue()), None)
    ...
    def test_anonymize_user_does_not_cascade(self):
        event_type = EventType.objects.create(owner=self.user, title="Test Event", duration_minutes=30)
